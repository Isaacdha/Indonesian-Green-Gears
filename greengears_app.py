...
st.sidebar.image('resource/Image.webp', use_column_width=True)
...
# Sidebar Footnote
if language == 'English':
    st.sidebar.markdown('***Capstone Project for TETRIS II 2022 By DQLab***')
    st.sidebar.markdown("The author realizes that there are still many shortcomings in the creation of this dashboard article. Suggestions and input can be sent to the author's email/LinkedIn")
else:
    st.sidebar.markdown('***Proyek Akhir untuk TETRIS II 2022 Oleh DQLab***')
    st.sidebar.markdown("Penulis sadar bahwa masih banyak kekurangan dalam pembuatan artikel dashboard ini. Saran dan masukan dapat dikirimkan ke email/LinkedIn penulis")

with st.sidebar.expander("News & Data Source"):
